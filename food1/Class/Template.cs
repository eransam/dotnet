...
namespace ReportServiceClass
{
        ...
        public static string getEnglishDate()
  {
      ...
      return returnValue;
        ...
        //public void exportPDFWithHebrewDateHand(string rptName, ArrayList arr, string pdfName,string dtHatchDate)
        //{
        ...
        //        connInfo.ServerName = Resources.Resource.ServerName;
        //        connInfo.UserID = "sa";

        //        connInfo.Password = "lul";
        //        connInfo.DatabaseName = Resources.Resource.DbName;
        ...
        //        oRpt2.DataDefinition.FormulaFields["HebrewDate"].Text = '"' + GetHebrewDateString(DateTime.Now, false).Replace("\"", "''").ToString() + '"';
        ...
        //public void exportPDFWithHebrewDateEGG(string rptName, ArrayList arr, string pdfName,string dtFrom,string dtTo)
        //{
        ...
        //        oRpt2.DataDefinition.FormulaFields["DtFr"].Text = '"' + dtFrom.Replace("\"", "''").ToString().Replace("00:00:00","") + '"';
        //        oRpt2.DataDefinition.FormulaFields["DtTo"].Text = '"' + dtTo.Replace("\"", "''").ToString().Replace("00:00:00", "") + '"';
        //           oRpt2.DataDefinition.FormulaFields["Usr"].Text = '"' + HttpContext.Current.Session["FullName"].ToString().Replace("\"", "''").ToString() + '"';
        //        oRpt2.DataDefinition.FormulaFields["DtHeb"].Text = '"' + GetHebrewDateString(DateTime.Now, false).Replace("\"", "''").ToString() + '"';
        ...
        //public bool exportExcel(string rptName, ArrayList arr, string excelName)
        //{
        ...
        //        crDiskFileDestinationOptions.DiskFileName = excelName;
        ...
        //public string printReport(string rptName, ArrayList arr,string printerName)
        //{
        //    string returnValue = "";
        ...
        //        connInfo.UserID = "sa";
        //        connInfo.Password = "lul";
        //        connInfo.DatabaseName = "ChickenHealth";
        ...
        //        oRpt2.PrintOptions.PrinterName = printerName;
        //        oRpt2.PrintToPrinter(1, false, 0, 0);
        ...
        /*
          public static bool sendEmail(string subject, string body, ArrayList arr,string attachmentFileUrl)
  {
      bool returnValue = true;
      ...
      try {
       ...
       for(int i=0;i<arr.Count;i++) {
             ...
             MailAddress SendFrom = new MailAddress("testlab@epb.org.il", "המועצה לענף הלול");
             MailAddress SendTo = new MailAddress(arr[i].ToString());
             MailMessage MyMessage = new MailMessage(SendFrom, SendTo);
